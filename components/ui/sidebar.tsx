...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute right-3 flex h-5 min-w-5 items-center justify-center rounded-md bg-sidebar-accent px-1 text-xs font-semibold tabular-nums text-sidebar-foreground select-none",
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "mx-5 flex min-w-0 flex-col gap-1 border-l border-sidebar-border pl-4 py-1",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
